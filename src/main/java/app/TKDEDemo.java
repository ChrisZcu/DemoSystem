...
//        initButton();
        ...
        new Thread() {
            ...
            public void run() {
                ...
                String qtPath = "data/GPS/QuadTreeIndex/new20230529/new_12d_quad_tree_delta" + delta + "_info.txt";
//                QuadTree.saveTreeToFile(qtPath);
//                System.out.println("save finished.");

                qtPath = "data/GPS/QuadTreeIndex/quad_tree_quality" + 8 + "_info.txt";
                QuadTree.loadTreeFromFile(qtPath);
                quadRegionRoot = QuadTree.quadRegionRoot;

//                quadRegionRoot = QuadTree.getQuadIndexPart(filePath, 12, delta);
//                QuadTree.quadRegionRoot = quadRegionRoot;
//                QuadTree.saveTreeToFile(qtPath);

//                for (int d: new int[]{4, 8, 16, 32, 64}){
//                    QuadTree.quadRegionRoot = null;
//                    qtPath = "data/GPS/QuadTreeIndex/new20230529/new_12d_quad_tree_delta" + d + "_info.txt";
//                    quadRegionRoot = QuadTree.getQuadIndexPart(trajFull, 12, d);
//                    QuadTree.quadRegionRoot = quadRegionRoot;
//                    QuadTree.saveTreeToFile(qtPath);
//                }
